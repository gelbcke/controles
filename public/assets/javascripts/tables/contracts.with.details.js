		...
		var fnFormatDetails = function( datatable, tr ) {
			...
			return [
				'<table class="table mb-none">',
					'<tr>',
						'<td><label class="mb-none">Custo Mensal:</label></td>',
						'<td>' + data[6] + '</td>',
					'</tr>',
					'<tr>',
						'<td><label class="mb-none">Custo Total:</label></td>',
						'<td>' + data[7] + '</td>',
					'</tr>',
					'<tr>',
						'<td><label class="mb-none">Observações:</label></td>',
						'<td> ' + data[8] + '</td>',
					'</tr>',
				'</div>'
			].join('');
