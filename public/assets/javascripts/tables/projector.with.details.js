		...
		var fnFormatDetails = function( datatable, tr ) {
			...
			return [
				'<table class="table mb-none">',
					'<tr class="b-top-none">',
						'<td><label class="mb-none">Cabeamento:</label></td>',
						'<td>' + data[7] + '</td>',
					'</tr>',
					'<tr>',
						'<td><label class="mb-none">Suporte:</label></td>',
						'<td>' + data[8] + '</td>',
					'</tr>',
					'<tr>',
						'<td><label class="mb-none">Última Atualização:</label></td>',
						'<td>' + data[9] + '</td>',
					'</tr>',
				'</div>'
			].join('');
