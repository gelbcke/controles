		...
		var fnFormatDetails = function( datatable, tr ) {
			...
			return [
				'<table class="table mb-none">',
					'<tr class="b-top-none">',
						'<td><label class="mb-none">Número de Série:</label></td>',
						'<td>' + data[7] + '</td>',
					'</tr>',
					'<tr>',
						'<td><label class="mb-none">Patrimônio:</label></td>',
						'<td>' + data[6] + '</td>',
					'</tr>',
					'<tr>',
						'<td><label class="mb-none">Fabricante:</label></td>',
						'<td>' + data[4] + '</td>',
					'</tr>',
					'<tr>',
						'<td><label class="mb-none">Modelo:</label></td>',
						'<td>' + data[5] + '</td>',
					'</tr>',
				'</div>'
			].join('');
