            ...
            <div class="row">
               <div class="col-sm-6">
                  <div class="form-group">
                     ...
                     <select class="form-control input-flat" name="unidade_id" required>
                        <option value="{{$bloco->unidade_id}}" selected>{{$bloco->unidade->name}}</option>
                        <option value="" disabled>---</option>
                        @foreach($unidades as $unidade)
                        <option value="{{$unidade->id}}"><i>{{$unidade->name}}</i></option>
                        @endforeach
                     </select>
                  </div>
               </div>
               <div class="col-sm-6">
                  <div class="form-group">
                     ...
                     <input type="text" name="name" class="form-control input-flat" value="{{$bloco->name}}" autocomplete="off" required>
                  </div>
               </div>
            </div>
         </div>
