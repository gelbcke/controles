            ...
            <div class="row">
               <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     ...
                     <div class="radio-custom radio-primary">
                        <input type="radio" class="radio-custom radio-primary" name="Radio_1" id="Radio_1" value="PF" required>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-9">                
                     ...
                     <div class="radio-custom radio-primary">
                        <input type="radio" class="radio-custom radio-primary" name="Radio_2" id="Radio_2" value="HARD" required>
            ...
            <div class="row">
               <div class="col-sm-6">
                  <div class="form-group">
                     ...
                     <input type="text" name="colaborador" id="colaborador" class="form-control input-flat" autocomplete="off" value="{{$termo->colaborador}}" required>
                  </div>
               </div>
               <div class="col-sm-6">
                  <div class="form-group">
                     <strong>Email: <span class="required">*</span></strong>
                     <input type="text" name="email" id="email" class="form-control input-flat" autocomplete="off" value="{{$termo->email}}" required>
                  </div>
               </div>
               <div class="col-sm-6">
                  <div class="form-group">
                     <strong>Gestor Imediato do Colaborador: </strong>
                     <input type="text" name="gestor_colab" id="gestor_colab" class="form-control input-flat" autocomplete="off" value="{{$termo->gestor_colab}}">
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-sm-2">
                  <div class="form-group">
                     ...
                     <input type="text" name="matricula" id="matricula" class="form-control input-flat" autocomplete="off" value="{{$termo->matricula}}" required>
                  </div>
               </div>
               <div class="col-sm-2">
                  <div class="form-group">
                     ...
                     <select class="form-control input-flat" name="referencia" onchange="refSelectCheck(this);" required>
                        <option value="{{$termo->referencia}}">{{$termo->referencia}}</option>
               ...
               <div class="col-sm-2">
                  <div class="form-group">
                     ...
                     <select class="form-control input-flat" name="fpw" required>
                        <option value="{{$termo->fpw}}">{{$termo->fpw}}</option>
               ...
               <div class="col-sm-2 inp_PF" style="display:none">
                  <div class="form-group">
                     ...
                     <input type="text" name="cpf" id="cpf" class="form-control input-flat " autocomplete="off" value="{{$termo->cpf}}" required>
                  </div>
               </div>
               <div class="col-sm-2 inp_PF" style="display:none">
                  <div class="form-group">
                     <strong>RG: <span class="required">*</span></strong>
                     <input type="text" name="rg" id="rg" class="form-control input-flat " autocomplete="off" value="{{$termo->rg}}" required>
                  </div>
               </div>
               <div class="col-sm-4 inp_PJ" style="display:none">
                  <div class="form-group">
                     <strong>CNPJ: <span class="required">*</span></strong>
                     <input type="text" name="cnpj" id="cnpj" class="form-control input-flat " autocomplete="off" value="{{$termo->cnpj}}" required>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-sm-3">
                  <div class="form-group">
                     <strong>Cargo: </strong>
                     <input type="text" name="cargo" id="cargo" class="form-control input-flat" autocomplete="off" value="{{$termo->cargo}}">
                  </div>
               </div>
               <div class="col-sm-3">
                  <div class="form-group">
                     <strong>Contato: </strong>
                     <input type="text" name="contato" id="contato" class="form-control input-flat" autocomplete="off" value="{{$termo->contato}}">
                  </div>
               </div>
                <div class="col-md-3">
                  <div class="form-group">
                     ...
                     <select id="unidade_id" name="unidade_id" class="form-control" required>   
                        <option value="{{$termo->unidade_id}}" selected>{{$termo->unidade->name}}</option>
               ...
               <div class="col-sm-3">
                  <div class="form-group">
                     ...
                     <input type="number" name="pat" id="pat" class="form-control input-flat" autocomplete="off" value="{{$termo->pat}}" required>
                  </div>
               </div>
               <div class="col-sm-3">
                  <div class="form-group">
                     <strong>Número de Série: <span class="required">*</span></strong>
                     <input type="text" name="ns" id="ns" class="form-control input-flat" autocomplete="off" value="{{$termo->ns}}" required>
                  </div>
               </div>
               <div class="col-sm-3">
                  <div class="form-group">
                     <strong>Equipamento: <span class="required">*</span></strong>
                     <input type="text" name="equipamento" id="equipamento" class="form-control input-flat" autocomplete="off" value="{{$termo->equipamento}}" required>
                  </div>
               </div>
               <div class="col-sm-3">
                  <div class="form-group">
                     <strong>Marca: <span class="required">*</span></strong>
                     <input type="text" name="marca" id="marca" class="form-control input-flat" autocomplete="off" value="{{$termo->marca}}" required>
                  </div>
               </div>
               <div class="col-sm-3">
                  <div class="form-group">
                     <strong>Modelo: <span class="required">*</span></strong>
                     <input type="text" name="modelo" id="modelo" class="form-control input-flat" autocomplete="off" value="{{$termo->modelo}}" required>
                  </div>
               </div>
               <div class="col-sm-3 inp_HARD" style="display:none">
                  <div class="form-group">
                     <strong>Processador: <span class="required">*</span></strong>
                     <input type="text" name="processador" id="processador" class="form-control input-flat" autocomplete="off" value="{{$termo->processador}}" required>
                  </div>
               </div>
               <div class="col-sm-3 inp_HARD" style="display:none">
                  <div class="form-group">
                     <strong>Memória RAM: <span class="required">*</span></strong>
                     <input type="text" name="memoria" id="memoria" class="form-control input-flat" autocomplete="off" value="{{$termo->memoria}}" required>
                  </div>
               </div>
               <div class="col-sm-3">
                  <div class="form-group">
                     <strong>Armazenamento: <span class="required">*</span></strong>
                     <input type="text" name="hd" id="hd" class="form-control input-flat" autocomplete="off" value="{{$termo->hd}}" required>
                  </div>
               </div>
               <div class="col-sm-3 inp_CEL" style="display:none">
                  <div class="form-group">
                     <strong>Operadora: <span class="required">*</span></strong>
                     <input type="text" name="operadora" id="operadora" class="form-control input-flat" autocomplete="off" value="{{$termo->operadora}}" required>
                  </div>
               </div>
               <div class="col-sm-3 inp_CEL" style="display:none">
                  <div class="form-group">
                     <strong>Número CHIP: <span class="required">*</span></strong>
                     <input type="text" name="num_chip" id="num_chip" class="form-control input-flat" autocomplete="off" value="{{$termo->num_chip}}" required>
                  </div>
               </div>
               <div class="col-sm-3">
                  <div class="form-group">
                     <strong>Empresa: <span class="required">*</span></strong>
                     <input type="text" name="empresa" id="empresa" class="form-control input-flat" autocomplete="off" placeholder="Ex. CESPO" value="{{$termo->empresa}}" required>
                  </div>
               </div>
               <div class="col-sm-5">
                  <div class="form-group">
                     <strong>Itens Adicionais: </strong>
                     <input type="text" name="itens_add" id="itens_add" class="form-control input-flat" autocomplete="off" value="{{$termo->itens_add}}">
                  </div>
               </div>
               <div class="col-sm-2">
                  <div class="form-group">
                     <strong>Retirada: </strong>
                     <input type="date" name="dt_retirada" id="dt_retirada" class="form-control input-flat" autocomplete="off" value="{{$termo->dt_retirada}}">
                  </div>
               </div>
               <div class="col-sm-2" id="EmprestimoCheck" style="display:none;">
                  <div class="form-group">
                     <strong>Devolução Empréstimo: </strong>
                     <input type="date" name="dt_entrega" id="dt_entrega" class="form-control input-flat" autocomplete="off" value="{{$termo->dt_entrega}}">
                  </div>
               </div>
               <div class="col-sm-3">
                  <div class="form-group">
               ...
               <div class="col-sm-12">
                  <div class="form-group">
                     ...
                     <textarea name="obs" class="form-control">{{$termo->obs}}"</textarea> 
                  </div>
               </div>
            </div>
            <hr>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select id="gerente_id" name="gerente_id" class="form-control" required>
                        <option value="{{$termo->gerente_id}}" selected>{{$termo->gerente->name}}</option>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select id="responsavel_id" name="responsavel_id" class="form-control" required>
                        <option value="{{$termo->responsavel_id}}" selected>{{$termo->responsavel->name}}</option>
                        @foreach($users as $value)
                        <option value="{{$value->id}}"> {{$value->name}}</option>
                        @endforeach
                     </select>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select id="testemunha_id" name="testemunha_id" class="form-control" required>
                        <option value="{{$termo->testemunha_id}}" selected>{{$termo->testemunha->name}}</option>
                        @foreach($users as $value)
                        <option value="{{$value->id}}"> {{$value->name}}</option>
                        @endforeach
                     </select>
...
<script src="{{ asset('assets/jquery/Mask/jquery.mask.js?update=1.03')}}"></script>
<script>
