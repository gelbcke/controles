        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="main-error mb-xlg">
                    <h2 class="error-code text-dark text-center text-semibold m-none"><b>401</b></h2>
                    <p class="error-explanation text-center">Você não possuí permissão para acessar esta página!</p>
                </div>
            </div>
            <div class="col-sm-4">
