<html>
   ...
   <body>
      ...
      <font face="Calibri" color="black">
         <p>Olá {{ $termo->colaborador }},</p>
         <p></p>
         <p>Viemos por meio deste confirmar a devolução do {{ $termo->equipamento }}, patrimônio {{ $termo->pat }}, realizada no dia {{ $termo->updated_at->format('d/m/Y') }}.
            <br>
